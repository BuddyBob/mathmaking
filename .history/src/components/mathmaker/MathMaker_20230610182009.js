            ...
            {matchedUsers.map(({ user, matchingScore }) => (
              <div
                className={`matched-user ${
                  flippedCards.includes(user.id) ? "flipped" : ""
                }`}
                key={user.id}
              ...
              >
                <div className="matched-user-info">
                  ...
                  <div className="matched-user-matching-score">
                    Score: {matchingScore}%
                  </div>
                  <br />
                  ...
                  <div className="matched-user-section">
                    ...
                    {user.grade &&
                      user.grade.map((grades) => (
                        <div className="grade" key={grades}>
                          {grades},
                        </div>
                      ))}
                  </div>
                ...
                <div className="matched-user-content">
                  <textarea
                    ...
                    onChange={(e) =>
                      handleUserTextChange(user.id, e.target.value)
                    }
