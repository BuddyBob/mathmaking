          ...
          <div className="selected-user">
              ...
              <a className="zoom-link" href="https://zoom.us/">Create Zoom Link</a>
                <div className="zoom-info">
                    <input className="zoom-time" id="zoom-link-input" type="text" placeholder="Enter Zoom Link" />
                    <input className="zoom-time" id="time-input" type="text" placeholder="Enter Time" />
                </div>
