                    ...
                    {matchedUsers.map(({ user, matchingScore }) => (
                        <div className="matched-user">
                            <div className="matched-user-info">
                                ...
                                <div className="matched-user-matching-score">{matchingScore}</div>
                            </div>
                            <div className="matched-user-interests">
                                {user.interests.map((interest) => (
                                    <div className="interest">{interest}</div>
                                ))}
                            </div>
                            <div className="matched-user-grades">
                                {user.interests.map((grades) => (
                                    <div className="grade">{interest}</div>
                                ))}
                            </div>
                        </div>
                    ))}
