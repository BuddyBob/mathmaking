  ...
  return (
    <div className="mm-container1">
      ...
      <div className="mm-container2">
        {userData && !selectedUser && ( // Show the Start Math Making button if userData is available and no user is selected
          <input
        ...
        {selectedUser && ( // Show the selected user's information if a user is selected
          <div className="selected-user">
            <div className="matched-user-info">
              <div className="matched-user-name">{selectedUser.user.username}</div>
              <div className="matched-user-matching-score">Score: {selectedUser.matchingScore}%</div>
              <br />
