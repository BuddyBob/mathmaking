        ...
        <div>
            ...
            <div className="data">
                ...
                <div className="interests">
                    ...
                    <Tag already={['Soccer']} tags_={['Sports', 'Programming', 'Engineering', "Cooking","Photography","Traveling","Painting","Reading","Sports","Gardening","Writing","Music","Hiking","Yoga","Fashion","Gaming","Dancing","Coding","Film and movies","Fitness and exercise","Meditation","Food and dining","DIY projects","Volunteer work","Collecting","Outdoor activities","Crafting","Pets and animals","History","Science and technology","Home decor","Learning new languages","Socializing and networking"]} />
                </div>
                <div className="grade">
