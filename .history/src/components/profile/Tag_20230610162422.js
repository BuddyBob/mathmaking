...
const Tag = (props) => {
  ...
  const handleTagSubmit = () => {
    // Call the handleSubmit function passed from the parent component with the selected tags and section
    props.handleSubmit(selectedTags, props.section);
  };
  ...
  return (
    <div className="tag-container">
      ...
      <button onClick={handleTagSubmit}>Submit</button> {/* Submit button for the section */}
    </div>
  );
};
