...
const Profile = () => {
  ...
  const handleSubmit = () => {
    ...
    const handleSubmit = () => {
        ...
        const updateData = {
          interests: interests.concat(selectedTags), // Assuming selectedTags is an array of tags
          grade: grades.concat(selectedGrade), // Assuming selectedGrade is the selected grade value
        };
