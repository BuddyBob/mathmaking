        ...
        {schedules.length > 0 ? (
            ...
            {schedules.map((schedule, index) => (
                <div className="sched-data">
                    ...
                    <strong ><div className="sched-text">Zoom Link</div></strong> {schedule.zoomLink}<br />
                    <strong ><div className="sched-text">Time</div>{schedule.time} </strong> {schedule.time}<br />
                </div>
            ))}
            </div>
        ) : (
